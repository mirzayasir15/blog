...
class Xcrud
{
    ...
    protected function create_relation($name, $value = '', $tag = array(), $dependval = false)
    {
            ...
            if ($this->lists_null_opt)
            {
                foreach ($values as $val)
                {
                    $out .= $this->open_tag(array(
                        'tag' => 'option',
                        'value' => $val,
                        'selected' => '')) . '-none-' . $this->close_tag('option');
                }
        ...
        else
        {
            ...
            if ($this->lists_null_opt)
            {
                $out .= $this->open_tag(array('tag' => 'option', 'value' => '')) . '-none-' . $this->close_tag('option');
            }
        }
        if ($options)
        {
    ...
    protected function render_grid_body($row_tag = array('tag' => 'tr'), $item = array('tag' => 'td'))
    {
        ...
        else
        {
            ...
            $out .= $this->open_tag($row_tag, 'xcrud-row') . $this->open_tag($item, '', array('colspan' => $j)) . 'no record found.' .
